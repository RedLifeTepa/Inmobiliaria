...
La V3.3.1 agrega recuperación del ejemplo TERRASER cuando ya no existe en Firebase y una ventana de confirmación antes de desactivar desarrollos. También mantiene el control en dashboard, edición, publicación y catálogo público de proyectos activos.
